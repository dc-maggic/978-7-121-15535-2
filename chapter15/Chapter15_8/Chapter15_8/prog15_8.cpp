...
int main()
{
	...
	vector<shared_ptr<Quote>> basket2;//在容器中放置（智能）指针而非对象
	basket2.push_back(make_shared<Quote>("0-201-82470-1", 50));
	basket2.push_back(make_shared<Bulk_quote>("0-201-82470-1", 50, 10, 0.25));
	cout << basket2.back()->net_price(15) << endl;//解引用
	system("pause");
	return 0;
}